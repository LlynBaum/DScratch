...
public abstract record StepDiff(string Type)
{
    ...
    public record InsertElementInlineDiff(string ParentId, int Offset, string TagName, string NewNodeId) : StepDiff("insertElementInline");
    ...
    /// <param name="TagName">The HTML Tag for the element to insert</param>
    /// <param name="NewNodeId">The id of the Node</param>
    public record InsertElementBlockDiff(string ParentId, string? PreviousSiblingId, string TagName, string NewNodeId) : StepDiff("insertElementBlock");
    ...
    public record MoveInlineDiff(string TargetNodeId, string TargetParentId, int TargetOffset) : StepDiff("moveInline");
    ...
    /// If null, it will be the first child of the parent.
    /// </param>
    public record MoveBlockDiff(string TargetNodeId, string TargetParentId, string? PreviousSiblingId) : StepDiff("moveBlock");
}