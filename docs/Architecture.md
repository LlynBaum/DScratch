...
Also there are Events that are dispatched by C# (e.g. in MenuBar). Then it looks like this:
1. Blazor Callback
2. C# requests Cursor Position from TS Layer
3. Dispatches a command to make a modification on the Tree or something else
4. Transaction generates a list of Diffs
5. Transaction send to Browser
6. TS manipulates dom
