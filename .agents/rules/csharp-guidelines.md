...
Refer to the [Architecture.md](file:///home/darki/Developement/DScratch/docs/Architecture.md) file for details. Code should be split cleanly according to the following roles:
